...
from .color_layer_dialog import ColorLayerDialog
import os.path
...
class ColorLayer:
    ...
    def __init__(self, iface):
        ...
        self.dlg = ColorLayerDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&Color Layer')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'ColorLayer')
        self.toolbar.setObjectName(u'ColorLayer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ColorLayer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/color_layer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Color Layer'),
            callback=self.run,
